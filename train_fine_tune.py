...
from cgma_net_v1 import CGMANet as MyNet_city
from cgma_net_v1 import msp_decoder as full_net
...
from utils.lr_scheduler import WarmupPolyLR, poly_learning_rate
...
def train_model(args):
    ...
    model_enc = MyNet_city(19) 
    model = full_net(model_enc)
    ...
    epoches = []
    mIOU_val_list = []
    lambda1 = lambda epoch: pow((1-((epoch-1)/args.max_epochs)),0.9)
    ...
    for epoch in range(start_epoch, args.max_epochs):
        ...
        model_checkpoint = args.savedir + '/checkpoint.pth'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default="CGMANet", help="model name")
    parser.add_argument('--dataset', default="cityscapes", help="dataset: cityscapes or camvid")
    parser.add_argument('--train_type', type=str, default="train",help="ontrain for training on train set, ontrainval for training on train+val set")
    parser.add_argument('--max_epochs', type=int, default=100,help="the number of epochs: 300 for train set, 350 for train+val set")
    parser.add_argument('--input_size', type=str, default="768,1536", help="input size of model") #"512,1024"
    ...
    parser.add_argument('--savedir', default="./cgma_net_fine_tune/", help="directory to save the model snapshot")
    parser.add_argument('--resume', type=str, default="",help="use this file to load last checkpoint for continuing training")
    parser.add_argument('--classes', type=int, default=19,help="the number of classes in the dataset. 19 and 11 for cityscapes and camvid, respectively")
    parser.add_argument('--logFile', default="log.txt", help="storing the training and validation logs")
    parser.add_argument('--cuda', type=bool, default=True, help="running on CPU or GPU")
    parser.add_argument('--gpus', type=str, default="0", help="default GPU devices (0,1)")
    parser.add_argument('--gpu_nums', type=int, default=1, help="number of gpus")
    args = parser.parse_args()
    
    
    if args.dataset == 'cityscapes':
        args.classes = 19
        args.input_size = '768,1536'
